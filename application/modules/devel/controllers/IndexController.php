...
{
	protected $serviceClassName 				= 'SanSIS_Service';
...
// 		chmod($ctl_path, 0777);
		...
		if (!file_exists($ctl_file))
		{
			...
			$class .= "	protected \$serviceClassName 			= '".$params['modulo_novo']."_Service_".$params['controlador_novo']."';\n";
			$class .= "\n";	
...
// 		chmod($service_path, 0777);
	
		$service_file = $service_path.DIRECTORY_SEPARATOR.$params['controlador_novo'].'.php';
		...
		if (!file_exists($service_file))
		{
			...
			$class .= " * @version	 1.0.0\n";
			$class .= " */\n";
			$class .= "class ".$params['modulo_novo']."_Service_".$params['controlador_novo']." extends SanSIS_Service\n";
			$class .= "{\n";
			$class .= "	/**\n";
			$class .= "	 * @var string\n";
			$class .= "	 */\n";
			...
			file_put_contents($service_file, $class);
	
// 			chmod($service_file, 0777);
		}
	}
