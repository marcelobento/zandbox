...
{	
	...
	const MSG_DBUSERERROR		= 'Não foi possível criar a conta de conexão ao banco. Verifique se os dados estão corretos. Caso o erro persista, execute esta ação manualmente.';
